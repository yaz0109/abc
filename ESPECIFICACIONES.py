...
def ESPECIFICACIONES ():
    ...
    st.markdown(f"<h3    style='text-align: center;'> ¿Por qué se usan Válvulas de compuerta? </h3>", unsafe_allow_html=True)
     st.write ()
    st.markdown("<div style='display: flex; justify-content: center;'><img src='https://i.pinimg.com/564x/4e/57/f4/4e57f477a95471f033d9516d52b07b99.jpg' alt='Imagen centrada' style='width: 400px; height: 300px;'></div>", unsafe_allow_html=True)
